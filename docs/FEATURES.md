...
| vv-integrity-hardening | stable | 0.8.0 | src/mcp/logTail.ts, .claude/hooks/planning-checklist.sh, .claude/skills/visual-verification/SKILL.md | MCP /log-tail endpoint, root-cause plan gate, positive-observable VV criteria gate, harness requirements tag; planning-checklist skips goal Status append while OXVEIL_VV_ACTIVE=1 (set at EDH launch, #141) |
